...
*/
		...
		function calculate()  {
				...
				$n = trim(esc_html(__('Next','church-admin' ) ).' '.$this->nextI);
				$p = trim( $this->prevI.' '.esc_html( __('Previous','church-admin')) );
				...
				*/
				...
				if( $lastpage > 1)  {
						...
						elseif( $lastpage > 1 + ( $this->adjacents * 2) )  {//enough pages to hide some
